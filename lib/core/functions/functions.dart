...
Future<void> storePrefs(String name, String value) async {
  try {
    await AppPreferences.shared.setString(name, value);
...
Future<String?> getPrefs(String name) async {
  try {
    return await AppPreferences.shared.getString(name);
  } catch (exception, stackTrace) {
...
Future<void> deletePrefs(String name) async {
  try {
    await AppPreferences.shared.remove(name);
  } catch (exception, stackTrace) {
    Sentry.captureException(exception, stackTrace: stackTrace);
...
Future<void> clearPrefs() async {
  await AppPreferences.shared.clear();
}
