                ...
                Expanded(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('${memberEntry.value['percentage']}%'),
                      Text(
                          '${memberEntry.value['attacksDone']}/${memberEntry.value['warParticipated']}'),
                    ],
                  ),
                ),
                Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                                "${(memberEntry.value['averageStars']).toStringAsFixed(1)}"),
                            SizedBox(
                                height: 20,
                                width: 20,
                                child: CachedNetworkImage(imageUrl: 
                        ...
                        Text(
                            '${(memberEntry.value['averagePercentage']).toStringAsFixed(1)}%'),
                      ],
                    ))
              ],
            )),
