                  ...
                  child: FutureBuilder<Map<String, Map<String, dynamic>>>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        List<Map<String, dynamic>> clansList = snapshot.data!.entries.map((entry) {
                          return {
                            'clanTag': entry.key,
                        ...
                        int clanPosition = clansList.indexWhere((clan) => clan['clanTag'] == widget.clanTag);

                        // Since index is 0-based, add 1 to get the position
                        clanPosition += 1;

                        int starsDifference = clansList[0]['stars'] - clansList[clanPosition - 1]['stars'];
                              ...
                              children: [
                                Column(
                                  children: [
                                    SizedBox(
                                      height: 30,
                                      child: CachedNetworkImage(imageUrl: "https://clashkingfiles.b-cdn.net/icons/Icon_HV_Podium.png"),
                                    ),
                                    Text(
                                      "$clanPosition",
                                ...
                                Column(
                                  children: [
                                    SizedBox(
                                      height: 30,
                                      child: CachedNetworkImage(imageUrl: "https://clashkingfiles.b-cdn.net/icons/Icon_DC_Hitrate.png"),
                                    ),
                                    Text(
              ...
              return Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text('Round $round', style: Theme.of(context).textTheme.titleLarge),
                  ),
                  ...snapshot.data!.map((warLeagueInfo) {
                    return RoundClanCard( warLeagueInfo: warLeagueInfo, discordUser: discordUser);
                  }),
                ],
              );
            } else {
