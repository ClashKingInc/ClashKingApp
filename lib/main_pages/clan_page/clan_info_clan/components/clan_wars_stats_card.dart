      ...
      title: Row(
        children: [
          ...
          Column(
            ...
            children: [
              Text(widget.clanInfo.name, style: Theme.of(context).textTheme.titleMedium),
              Text(widget.clanInfo.tag, style: Theme.of(context).textTheme.labelLarge),
            ],
          ),
        ],
      ),
      content: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Wrap(
              ...
              children: [
                Chip(
                  ...
                  label: Text(
                    widget.clanInfo.warWins.toString(),
                ...
                Chip(
                  ...
                  label: Text(
                    widget.clanInfo.warTies.toString(),
                    style: Theme.of(context).textTheme.labelLarge
                  ),
                ),
                Chip(
                  ...
                  label: Text(
                    widget.clanInfo.warLosses.toString(),
                    style: Theme.of(context).textTheme.labelLarge
                  ),
                ),
                Chip(
            ...
            widget.clanInfo.isWarLogPublic 
              ? Text(
