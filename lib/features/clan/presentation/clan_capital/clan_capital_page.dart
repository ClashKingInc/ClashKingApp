...
class CapitalScreen extends StatefulWidget {
  final Clan? clanInfo;
  CapitalScreen({super.key, required this.clanInfo});
...
/*
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        if (filterBy == "all" || filterBy == "done")
                          buildLastRaidsMembers(firstRaid),
                        if ((filterBy == "all" || filterBy == "notDone") &&
                            isOngoing)
  ...
  List<Widget> buildNonParticipantWidgets(List<Member> nonParticipants) {
    return nonParticipants
        .where((member) =>
            !filterAccountActive || widget.user.contains(member.tag))
        .map((member) {
      return Card(
            ...
            children: [
              SizedBox(
                ...
                child: CachedNetworkImage(
                  errorWidget: (context, url, error) => Icon(Icons.error),
                  imageUrl:
                      'https://assets.clashk.ing/capital-base/clan-houses/Building_CC_Vacant_House.png',
                ),
              ),
              SizedBox(width: 8),
              Expanded(
                    ...
                    children: [
                      ...
                      isOngoing
                          ? CachedNetworkImage(
                              ...
                              width: 24,
                              imageUrl:
                                  'https://assets.clashk.ing/bot/icons/animated_clash_swords.gif',
                            )
                          : SizedBox.shrink(),
                    ],
                  ),
                                  ...
                                  SizedBox(
                                    ...
                                    child: CachedNetworkImage(
                                      errorWidget: (context, url, error) =>
                                          Icon(Icons.error),
                                      imageUrl:
                                          'https://assets.clashk.ing/bot/icons/raid_medal.png',
                                    ),
                                  ),
                                  SizedBox(width: 4),
                                  Text(
                                  ...
                                  ClipRect(
                                    child: Transform.scale(
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        fit: BoxFit.cover,
                                        imageUrl:
                                            'https://assets.clashk.ing/capital-base/capital-hall-pics/Building_CC_District_Hall_level_5.png',
                                      ),
                                    ),
                                  ),
                                  SizedBox(width: 2),
                                  ...
                                  ClipRect(
                                    child: Transform.scale(
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        fit: BoxFit.cover,
                                        imageUrl:
                                            'https://assets.clashk.ing/bot/icons/thick_capital_sword.png',
                                      ),
                                    ),
                                  ),
                                ],
            ...
            children: [
              SizedBox(
                ...
                child: CachedNetworkImage(
                  errorWidget: (context, url, error) => Icon(Icons.error),
                  imageUrl:
                      'https://assets.clashk.ing/capital-base/clan-houses/Building_CC_Clan_House.png',
                ),
              ),
              SizedBox(width: 8),
              Expanded(
