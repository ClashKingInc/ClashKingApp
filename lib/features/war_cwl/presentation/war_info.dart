...
import 'package:clashkingapp/features/war_cwl/models/war_member.dart'
    show WarMember;
import 'package:clashkingapp/features/war_cwl/presentation/widgets/war_calculator_card.dart'
    show WarCalculatorCard;
import 'package:clashkingapp/features/war_cwl/presentation/widgets/war_events_card.dart';
import 'package:clashkingapp/features/war_cwl/presentation/widgets/war_header.dart';
import 'package:clashkingapp/features/war_cwl/presentation/widgets/war_statistics_card.dart';
import 'package:clashkingapp/features/war_cwl/presentation/widgets/war_team_card.dart'
    show WarTeamCard;
...
class WarInfoScreen extends StatefulWidget {
  final WarInfo war;

  const WarInfoScreen({super.key, required this.war});

  @override
  State<WarInfoScreen> createState() => _WarInfoScreenState();
}
...
class _WarInfoScreenState extends State<WarInfoScreen>
            ...
            ScrollableTab(
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    children: [
                      WarStatisticsCard(warInfo: widget.war),
                      const SizedBox(height: 10),
                      WarCalculatorCard(warInfo: widget.war),
                    ],
                  ),
                ),
                WarEventsCard(warInfo: widget.war),
                Padding(
                  padding: const EdgeInsets.all(8),
                  child: Column(
                    children: [
