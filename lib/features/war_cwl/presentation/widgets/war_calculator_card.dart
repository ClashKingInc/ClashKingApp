...
class WarCalculatorCardState extends State<WarCalculatorCard> {
  ...
  void initState() {
    ...
    final diff = (clan?.destructionPercentage ?? 0) - (opponent?.destructionPercentage ?? 0);
    final neededPercent = (diff.abs() + 0.01).toStringAsFixed(2);
    _percentNeededController.text = neededPercent;

    _result = double.parse(neededPercent) * double.parse(_teamSizeController.text);
  }
          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.calculate, color: Theme.of(context).colorScheme.onSurface),
                  Padding(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton(
                        onPressed: () {
                          setState(() {
                            _result = parseDouble(_percentNeededController.text) *
