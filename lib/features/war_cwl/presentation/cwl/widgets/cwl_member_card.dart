...
class MembersCard extends StatelessWidget {
  ...
  Widget? getStatFromSortKey(BuildContext context) {
    ...
    switch (sortBy) {
      ...
      case 'attackOrder':
        return withImageIcon(
          member.avgAttackOrder?.toStringAsFixed(1) ?? "-",
          ImageAssets.iconClock,
          "Attack Order",
        );
      ...
      case 'defenseOrder':
        return withImageIcon(
          member.avgDefenseOrder?.toStringAsFixed(1) ?? "-",
          ImageAssets.iconClock,
          "Defense Order",
        );
              ...
              Wrap(
                ...
                children: [
                  ...
                  _FlatStat(
                    ...
                    value: attack.averageDestruction.toStringAsFixed(1),
                    icon: MobileWebImage(
                      imageUrl: ImageAssets.hitrate,
                      width: 16,
                      height: 16,
              ...
              Wrap(
                ...
                children: [
                  ...
                  _FlatStat(
                    ...
                    value: defense.averageDestruction.toStringAsFixed(1),
                    icon: MobileWebImage(
                      imageUrl: ImageAssets.hitrate,
                      width: 16,
                      height: 16,
