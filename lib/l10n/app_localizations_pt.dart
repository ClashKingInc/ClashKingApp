...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get createGuestProfile => 'Cria o seu perfil de convidado';
  ...
  @override
  String get noLegendData => 'Não foram encontrados Dados Lendários por hoje';
  ...
  String joinLeaveDifferenceUpDescription(int number, String date) {
    return 'O seu clã ganhou $number novo(s) membro(s) esta temporada ($date).';
  }
