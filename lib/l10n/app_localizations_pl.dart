...
class AppLocalizationsPl extends AppLocalizations {
  ...
  @override
  String get noLegendData => 'Nie znaleziono danych z legendy na dzisiaj';
  ...
  String joinLeaveDifferenceUpDescription(int number, String date) {
    return 'Twój klan zyskał $number nowych członków w tym sezonie ($date).';
  }
