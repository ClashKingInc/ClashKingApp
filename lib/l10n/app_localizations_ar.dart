...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get faqApiLimitation => 'حدود API لمعركة حرب العصابات';

  @override
  String get faqApiLimitationAnswer =>
      'بعض البيانات مقدمة من Clash of العصابات، و API لديها بعض القيود. وهذه هي الحالة فيما يتعلق بتعقب الأسطورة، فهي في بعض الأحيان تكبح الكأس والخسارة كما لو كانت هجوما واحدا. هذا أيضا هو السبب في أننا لا نملك أي معلومات عن مستوى المبنى الخاص بك.';

  @override
  String get faqSupportWork => 'كيف يمكنني دعم عملك؟';

  @override
  String get faqSupportWorkAnswer => 'هناك عدة طرق لدعمنا:';

  @override
  String get faqUseCodeClashKing => 'استخدام الرمز \"ClashKing\"';

  @override
  String get faqSupportUsOnPatreon => 'دعمنا على باتريون';

  @override
  String get faqShareTheApp => 'شارك التطبيق مع أصدقائك';

  @override
  String get faqRateTheApp => 'قيّم التطبيق في المتجر';

  @override
  String get faqHelpUsTranslate => 'ساعدنا على ترجمة التطبيق';

  @override
  String get faqHowToInviteTheBot =>
      'كيف يمكنني دعوة بوت الخاص بك إلى خادم ديسكورد؟';

  @override
  String get faqHowToInviteTheBotAnswer =>
      'يمكنك دعوة بوت إلى الخادم الخاص بك بالنقر على الزر أدناه. ستحتاج إلى إذن \"إدارة الخادم\" لإضافة البوت.';
  ...
  String get faqNeedHelp =>
      'أحتاج إلى المساعدة أو أود أن أتقدم باقتراح. كيف يمكنني الاتصال بك؟';
  ...
  @override
  String get faqSendEmail => 'إرسال بريد إلكتروني';

  @override
  String get faqJoinDiscord => 'انضم إلى خادم ديسكورد';

  @override
  String get faqCannotOpenMailClient =>
      'لبعض الأسباب لا يمكننا فتح عميل بريدك الإلكتروني. قمنا بنسخ عنوان البريد الإلكتروني لك. يمكنك كتابة بريد إلكتروني ولصق العنوان في حقل المستلم.';
