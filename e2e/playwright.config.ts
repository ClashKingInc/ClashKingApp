...
export default defineConfig({
  ...
  projects: [
    ...
    // Logout invalidates the shared server-side web session. Run it only after
    // every other authenticated spec has completed, and consume that session
    // exactly once so parallel pages cannot make the suite order-dependent.
    {
