...
void main() {
  ...
  testWidgets(
    'keeps the ranked summary compact and popular troops in one row',
    (tester) async {
      ...
      expect(popularTiles, findsNWidgets(3));
      final top = tester.getTopLeft(popularTiles.first).dy;
      expect(tester.getTopLeft(popularTiles.at(1)).dy, top);
      expect(tester.getTopLeft(popularTiles.at(2)).dy, top);
