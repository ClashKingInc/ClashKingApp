...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new exe.shyam.scrollable_tab_view.ScrollableTabViewPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin scrollable_tab_view, exe.shyam.scrollable_tab_view.ScrollableTabViewPlugin", e);
    }
    try {
